...
\begin{itemize}
    \item Каноническое уравнение
          ...
          Из \(r_1 = 2a + r_2\) получаем \(r_1 = x \varepsilon + a\). Значит \fbox{\(r_{1, 2} = x \varepsilon \pm a\)}
    ...
    \item Полярное уравнение:
          ...
          Зададим ПСК\((r, \varphi)\), у которой полюс \(O'= F_2 = (c, 0)\), а ось направлена в сторону, противоположную направлению оси \(Ox\).
...
\begin{enumerate}
    ...
    \item $\forall x \in V \medspace \forall \alpha \in \mathbb{R}(\mathbb{C}) : ||\alpha x|| = |\alpha|||x||$.
\end{enumerate}
